...
<form method="post" action="/posts" enctype="multipart/form-data">
  ...
  <div class="form-outline mb">
    <textarea class="form-control" id="form4Example3" style="min-height: 200px;" name="content"></textarea>
  ...
  <!-- highlight input -->
  <div class="form-outline mb">
    <textarea class="form-control" id="form4Example3" style="min-height: 100px;" name="highlight"></textarea>
